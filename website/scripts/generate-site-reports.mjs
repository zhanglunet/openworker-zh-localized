...
const enterpriseLayers = [
  {
    ...
    files: ["coworker/providers/registry.py", "coworker/providers/matrix.py", "docs/config.example.toml"],
  },
  {
    layer: "技能层 · 企业技能包",
    grade: "资产级",
    ...
    files: ["coworker/skills/base.py", "coworker/skills/store.py"],
  },
  {
    layer: "知识层 · 企业知识库",
    grade: "资产级起步",
    ...
    files: ["coworker/roots.py", "coworker/project.py", "coworker/memory"],
  },
  {
    ...
    files: ["coworker/mcp", "coworker/connectors/descriptors.py", "coworker/cli.py"],
  },
  {
    layer: "专属功能 · 大表哥表格助手",
    grade: "三层渐进",
    ...
    files: ["coworker/tools", "surfaces/gui/src/App.tsx"],
  },
  {
    layer: "品牌层 · 换肤与命名",
    grade: "资产级",
    ...
    files: ["surfaces/gui/src/styles.css", "surfaces/gui/tailwind.config.js", "surfaces/gui/src-tauri/tauri.conf.json"],
  },
  {
    layer: "同步层 · 三仓不覆盖同步",
    grade: "流水线",
  ...
  },
  {
    ...
    files: [".github/workflows/release.yml", "packaging/build_dmg.sh", "packaging/make_update_manifest.py"],
  },
];
